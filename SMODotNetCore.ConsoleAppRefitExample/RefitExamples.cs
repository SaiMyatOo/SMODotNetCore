...
using static SMODotNetCore.ConsoleAppRefitExample.IBlogApi;

namespace SMODotNetCore.ConsoleAppRefitExample
{
    internal class RefitExamples
    {
        private readonly IBlogApi _service = RestService.For<IBlogApi>("https://localhost:7289");
